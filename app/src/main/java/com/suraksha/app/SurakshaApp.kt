    ...
    override fun onCreate() {
        ...
        try {
            ...
            if (apiKey.isEmpty() || apiKey == "YOUR_API_KEY_HERE") {
                Log.e("SurakshaApp", "âš ï¸ Invalid API key. Places SDK not initialized.")
            ...
            if (!Places.isInitialized()) {
                ...
                Log.d("SurakshaApp", "âœ… Places SDK initialized successfully!")
            } else {
                Log.d("SurakshaApp", "Places SDK already initialized.")
            }
        } catch (e: Exception) {
            Log.e("SurakshaApp", "âŒ Failed to initialize Places SDK: ${e.message}", e)
        }
    }
}